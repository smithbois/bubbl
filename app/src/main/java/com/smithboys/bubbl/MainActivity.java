...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        GlobalUsers.initializeUsers();
        GlobalBubbles.initializeBubbles();
